...
Subsetting and cropping curvilinear grid is not supported by [stars](https://CRAN.R-project.org/package=stars) because (I think) gdal doesn't support it.  We can transform (warp) to a regular grid and then subset.
