...
Subsettng and cropping curvilinear grid is not supported by [stars](https://CRAN.R-project.org/package=stars).  But it does mask regular grids, so transforming to a regular grid can help.
